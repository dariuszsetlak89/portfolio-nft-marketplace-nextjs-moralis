...
export default function BuyNftModal({ nftAddress, tokenId, price, isVisible, marketplaceAddress, onClose }) {
    ///////////////////
    //  State Hooks  //
    ///////////////////
    ...
    return (
        <Modal
            title={<div className="p-2 text-3xl text-blue-600 font-bold">Buy NFT item</div>}
            isVisible={isVisible}
            width="800px"
        ...
        >
            <div>
                ...
                <div className="m-5 flex-row justify-center">
